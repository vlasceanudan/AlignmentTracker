require([
  ...
  const TRANSLATIONS = {
    ...
    ro: {
      ...
      project: "Proiect", alignment: "Aliniere",
      selectProject: "Selectează proiect", selectProjectFirst: "Selectează mai întâi un proiect",
      selectAlignment: "Selectează aliniere",
      noAlignment: "Nicio aliniere selectată",
      loadingAlignments: "Se încarcă aliniamentele...",
      chooseProject: "Alege un proiect, apoi selectează un aliniament.",
      selectAnAlignment: "Selectează un aliniament.",
      selectAProject: "Selectează un proiect.",
      selectAlignmentFirst: "Selectează mai întâi un aliniament.",
      trackModeReady: "Modul urmărire activ.",
      alignmentOutOfBounds: "Aliniament în afara limitelor.",
      ...
      chainageOutsideAlignment: "Km țintă este în afara acestui aliniament.",
      unableToResolve: "Nu se poate rezolva km țintă.",
      clickCloser: "Apasă mai aproape de aliniament pentru a seta o țintă.",
      chooseProjectFirst: "Alege mai întâi un proiect.",
      selectAlignmentSimulate: "Selectează un aliniament înainte de a simula o poziție.",
      failedToLoad: "Eroare la încărcarea stratului de aliniere.",
      ...
      shareAppTitle: "Tracker Aliniere",
      shareProjectLabel: "Proiect", shareAlignmentLabel: "Aliniere",
